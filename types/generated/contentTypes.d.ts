...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    factory: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    point: Schema.Attribute.Component<'components.about-highlights', true>;
    publishedAt: Schema.Attribute.DateTime;
    service: Schema.Attribute.Component<'components.about-services', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    googlemap: Schema.Attribute.Component<'components.link', true>;
    googlereviewurl: Schema.Attribute.Component<'components.link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderStatus: Schema.Attribute.Enumeration<
      ['order placed', 'pending', 'paid', 'shipped', 'delivered', 'cancelled']
    >;
    publishedAt: Schema.Attribute.DateTime;
